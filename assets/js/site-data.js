window.SITE_DATA = {
  ...
  portfolio: {
    ...
    about: {
      title: '私について',
      text: '国内最大手の美容外科に勤務し、\n信頼性と正確性が最優先される環境で業務に従事してきました。\n成果がブランド価値に直結する現場において、品質管理・顧客心理・再現性の重要性を実務を通して学びました。\n\n現在はHTML / CSS / JavaScriptを用いたLP制作を行っています。\nデザインの忠実な再現にとどまらず、表示パフォーマンス・可読性・保守性を考慮した構造設計を重視しています。\n\nまた、DIYを趣味としており、二次元・三次元を問わず構造から考えて制作することを大切にしています。\n見た目だけでなく「破綻しない設計」を前提とする姿勢は、Web制作においても一貫しています。\n\n静的LPの構築からWordPress移行・テーマ化まで一貫対応可能です。\n制作後の運用効率や拡張性を見据え、実務に耐える構成で実装いたします。',
      sub: 'HTML / CSS / JavaScript / WordPress / Figma'
    },
    story: {
      title: '強みとスタイル',
      catch: 'デザインから実装まで一貫して対応します。',
      text: '目的定義から情報設計を行い、成果に直結する構造へ落とし込みます。\n感覚的な実装ではなく、論理的根拠に基づいたページ構成を前提としています。\n品質がブランドに直結する現場で培った精度への意識を制作にも反映し、\n設計段階から運用フェーズまでを見据えた実装を行います。\n軽量性・可読性・保守性を担保し、拡張を前提とした構造で構築します。\n静的構築からWordPressテーマ設計まで一貫対応可能です。\n'
    },
    pricing: [
